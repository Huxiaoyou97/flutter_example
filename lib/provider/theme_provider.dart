...
class ThemeProvider extends ChangeNotifier {
  ...
  void setTheme([ThemeMethod themeMode = ThemeMethod.themeLight]) {
    XbAESStorageUtils.saveString(_appThemeKey, _methodValues[themeMode]!);
    notifyListeners();
  }
  ...
  ThemeMode getThemeMode() {
    final String theme = XbAESStorageUtils.getString(_appThemeKey) ?? '';
    switch (theme) {
      case _themeLight:
...
class MyThemes {
  static final lightTheme = ThemeData(
    primarySwatch: XbColorUtils.materialColor(KColors.kThemeColor),
  ...
  static _m2ThemeData(Color themeColor, {bool isDarkMode = false}) {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        systemOverlayStyle:
            XbStatusBarUtils.getStatusBarStyle(isDark: isDarkMode),
