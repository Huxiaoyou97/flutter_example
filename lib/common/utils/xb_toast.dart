...
/// XbToastWidget
class XbToastWidget extends StatelessWidget {
  const XbToastWidget({
    Key? key,
    required this.msg,
    this.image,
...
_HideCallback _showXbToast({
  ...
  var backButtonName = 'XbToast$backButtonIndex';
