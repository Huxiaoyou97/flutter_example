/// xb_storage_utils.dart
/// author: Huxiaoyou
/// description: AES 数据存储（封装第三方）

import 'dart:convert';
import 'package:flutter_demo01/common/utils/sp_util.dart';
import 'package:flutter_demo01/common/utils/xb_encrypt_utils.dart';


/// AES 加密存储
class XbAESStorageUtils {
  /// 存 String
  static Future<bool>? saveString(String key, String value) {
    key = XbEncryptUtils.aesEncrypt(key);
    value = XbEncryptUtils.aesEncrypt(value);
  ...
  static String? getString(String key) {
    ...
    if (enValue.isNotEmpty) {
      return XbEncryptUtils.aesDecrypt(enValue);
    }
    return null;
  }
