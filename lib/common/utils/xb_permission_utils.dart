...
import 'package:flutter_demo01/configs/strings.dart';
import 'package:permission_handler/permission_handler.dart';

import 'xb_device_utils.dart';

class XbPermissionUtils {
  /// 请求权限
  ...
  static _showDialog(String message) {
    Future.delayed(const Duration(milliseconds: 200), () {
      ...
      XbDialog.show(context, title: '提示', content: message, clickBtnPop: false,
          onConfirm: () {
...
// if (!isGrantedCamera) {
//   XbProgressHUD.showText('暂无相机权限,请前往设置开启权限');
//   return;
// }
//
// // 麦克风权限
...
//   XbProgressHUD.showText('暂无麦克风权限,请前往设置开启权限');
//   return;
// }
