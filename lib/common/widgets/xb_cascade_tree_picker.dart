...
class XbCascadePickerView extends StatefulWidget {
  const XbCascadePickerView({
    Key? key,
    required this.data,
  ...
  @override
  State<XbCascadePickerView> createState() => _XbCascadePickerViewState();
}

class _XbCascadePickerViewState extends State<XbCascadePickerView>
  ...
  Widget build(BuildContext context) {
    ...
    var lineColor = KColors.dynamicColor(context,
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              right: 0,
              child: InkWell(
                onTap: () => XbNavUtils.goBack(context),
                child: Container(
    ...
    return !widget.isShowSearch
        ...
        : Container(
            ...
            child: XbSearchBar(
              ...
              text: _searchKeyword,
              inputCallBack: XbCommonUtils.debounceInput((value) {
                setState(() {
