...
class XbPhotoBrowserView extends StatefulWidget {
  const XbPhotoBrowserView({
    Key? key,
  ...
  @override
  State<XbPhotoBrowserView> createState() => _XbPhotoBrowserViewState();
}

class _XbPhotoBrowserViewState extends State<XbPhotoBrowserView> {
  int _currentIndex = 0;
  ...
  Widget _body() {
    return Stack(
      children: <Widget>[
        ...
        Positioned(
          top: XbScreenUtils.topSafeHeight + 20,
          left: 0,
          right: 0,
          height: 30,
          child: Offstage(
