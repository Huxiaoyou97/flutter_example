/// xb_pulse_animation_view.dart
/// author: Huxiaoyou
/// description: 脉冲动画组件  跳动动画 先放大再缩小再还原

import 'package:flutter/material.dart';

class XbPulseAnimationView extends StatefulWidget {
  const XbPulseAnimationView({
    Key? key,
    required this.child,
  ...
  @override
  State<XbPulseAnimationView> createState() => _XbPulseAnimationViewState();
}

class _XbPulseAnimationViewState extends State<XbPulseAnimationView> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant XbPulseAnimationView oldWidget) {
