...
class XbBottomSheetView extends StatefulWidget {
  const XbBottomSheetView({
    Key? key,
    this.title,
    this.dataArr,
    this.redBtnTitle,
  ...
  @override
  State<XbBottomSheetView> createState() => _XbBottomSheetViewState();
}

class _XbBottomSheetViewState extends State<XbBottomSheetView> {
  ...
  _body() {
    ...
    return Container(
      color: bgColor,
      height: bgHeight + XbScreenUtils.bottomSafeHeight,
      child: Column(
        children: <Widget>[
          Container(
            color: bgColor,
          ...
          GestureDetector(
            child: Container(
              padding: EdgeInsets.only(bottom: XbScreenUtils.bottomSafeHeight),
              height: _cellHeight + XbScreenUtils.bottomSafeHeight,
              color: bgColor,
              child: Center(
                child: Text(
                  _cancelText,
