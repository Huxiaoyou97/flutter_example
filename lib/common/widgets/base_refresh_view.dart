...
/// author: Huxiaoyou
/// description: 通用下拉刷新组件

import 'dart:async';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:easy_refresh/easy_refresh.dart';
import 'package:flutter_demo01/common/widgets/xb_empty_view.dart';
import 'package:flutter_demo01/http/dio_utils.dart';
...
/// 父组件中调用 globalKeyRefresh.currentState.xbRequestData()
/// 初始化调用要延时加载
...
class BaseRefreshViewState<T extends BaseRefreshView> extends State<T> {
  ...
  _emptyWidget() {
    ...
    return XbEmptyView(text: widget.emptyText);
  }
  ...
  /// 网络请求
  void xbRequestData(String url, Map<String, dynamic>? params,
    ...
    if (widget.controller == null) {
      if (isLoadMore) {
        if (widget.onLoad != null) {
          _controller.finishLoad(tempData.length == widget.limit
