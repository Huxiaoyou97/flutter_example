...
import 'package:flutter_demo01/common/xb_form/xb_text_field.dart';
...
class XbSetCell extends StatefulWidget {
  const XbSetCell({
    Key? key,
    this.title = '',
    this.leftImgPath,
  ...
  @override
  _XbSetCellState createState() => _XbSetCellState();
}

class _XbSetCellState extends State<XbSetCell> {
