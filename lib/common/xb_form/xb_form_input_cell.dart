...
class XbFormInputCell extends StatefulWidget {
  const XbFormInputCell({
    Key? key,
    this.title = '',
    this.text = '',
    this.labelText = '',
  ...
  @override
  State<XbFormInputCell> createState() => _XbFormInputCellState();
}

class _XbFormInputCellState extends State<XbFormInputCell> {
  @override
