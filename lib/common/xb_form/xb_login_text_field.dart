...
import 'package:flutter_demo01/common/utils/xb_color_utils.dart';
...
class XbLoginTextField extends StatefulWidget {
  const XbLoginTextField({
    Key? key,
    this.text = '',
    this.hintText = '',
    this.labelText,
  ...
  @override
  State<XbLoginTextField> createState() => _XbLoginTextFieldState();
}

class _XbLoginTextFieldState extends State<XbLoginTextField> {
  ...
  @override
  void didUpdateWidget(covariant XbLoginTextField oldWidget) {
...
//      _pwdImg = _pwdShow?ImageIcon(AssetImage('assets/images/ic_pwd_close.png')):ImageIcon(AssetImage('assets/images/ic_pwd_open.png')) ;
    ...
    return Theme(
      ...
      data: ThemeData(
        ...
        primarySwatch: XbColorUtils.materialColor(themeColor),
