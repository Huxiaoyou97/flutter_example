...
class XbTextField extends StatefulWidget {
  ...
  @override
  _XbTextFieldState createState() => _XbTextFieldState();
}

class _XbTextFieldState extends State<XbTextField> {
  ...
  @override
  void didUpdateWidget(covariant XbTextField oldWidget) {
