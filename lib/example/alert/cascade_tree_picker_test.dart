...
import 'package:flutter_demo01/common/widgets/xb_cascade_tree_picker.dart';
...
final List titleData = [
  'XbCascadeTreePicker-都是三列',
  'XbCascadeTreePicker-不定列',
  'XbCascadeTreePicker-不定列-隐藏搜索',
  'XbCascadeTreePicker-不定列-默认选中(三级)',
  'XbCascadeTreePicker-不定列-默认选中(只有两级)',
  'XbCascadeTreePicker-第一列长度为1',
  'XbCascadeTreePicker-第一列长度为1-默认选中',
];
...
class CascadeTreePickerTest extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: BaseAppBar("XbCascadeTreePicker"),
      body: XbTextList(
          dataArr: titleData,
          callBack: (index, str) {
            if (str == 'XbCascadeTreePicker-都是三列') {
              XbCascadeTreePicker.show(context,
                  data: treeData3,
                  labelKey: 'label',
            ...
            if (str == 'XbCascadeTreePicker-不定列') {
              XbCascadeTreePicker.show(context,
                  data: treeData,
                  labelKey: 'label',
                  title: '请选择类型',
            ...
            if (str == 'XbCascadeTreePicker-不定列-隐藏搜索') {
              XbCascadeTreePicker.show(context,
                  data: treeData,
                  isShowSearch: false,
                  labelKey: 'label',
            ...
            if (str == 'XbCascadeTreePicker-不定列-默认选中(三级)') {
              // var tempArr = [
            ...
            if (str == 'XbCascadeTreePicker-不定列-默认选中(只有两级)') {
              // var tempArr = [
            ...
            if (str == 'XbCascadeTreePicker-第一列长度为1') {
              XbCascadeTreePicker.show(context, data: treeData4, title: '请选择类型',
            ...
            if (str == 'XbCascadeTreePicker-第一列长度为1-默认选中') {
