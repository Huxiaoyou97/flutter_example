      ...
      children: [
        ...
        Visibility(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              // 返回上级带参数
              XbNavUtils.goBackWithParams(context, {'isRefresh': true});
            },
          ),
        ),
        Visibility(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              // 返回上级带参数
              XbNavUtils.goBackWithParams(context, {'isRefresh': false, 'value2': 456});
            },
          ),
        ),
        Visibility(
          ...
          child: ElevatedButton(
            child: const Text('点击返回 - XbNavUtils.goBack'),
            onPressed: () {
              // 返回上级
        ...
        Visibility(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              ...
              // 效果同上，基于Navigator封装
              XbNavRouterUtils.goBackWithParams(context, {'isRefresh': false, 'value2': 4567});
            },
          ),
        ),
        Visibility(
